...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        //db.execSQL("CREATE TABLE CHAT_CONTACTS(ID INTEGER PRIMARY KEY AUTOINCREMENT, UID INTEGER NOT NULL UNIQUE, UNAME VARCHAR(90), UPLACE VARCHAR(120), USTATUS VARCHAR(360),HIMAGE VARCHAR(60) DEFAULT 'user_files/download.svg')");
    }
